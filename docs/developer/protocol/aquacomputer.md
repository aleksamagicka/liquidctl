...
| What                         | Where/starts at (offset) |
|------------------------------|--------------------------|
| Fan 1 speed control subgroup | 0x5A                     |
| Fan 2 speed control subgroup | 0xAF                     |
| Fan 3 speed control subgroup | 0x104                    |
| Fan 4 speed control subgroup | 0x159                    |
| Fan 5 speed control subgroup | 0x1AE                    |
| Fan 6 speed control subgroup | 0x203                    |
| Fan 7 speed control subgroup | 0x258                    |
| Fan 8 speed control subgroup | 0x2AD                    |
...
| What                         | Where/starts at (offset) |
|------------------------------|--------------------------|
| Fan 1 speed control subgroup | 0x36                     |
| Fan 2 speed control subgroup | 0x8B                     |
| Fan 3 speed control subgroup | 0xE0                     |
| Fan 4 speed control subgroup | 0x135                    |